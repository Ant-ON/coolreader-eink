...
public class BaseListView  extends ListView {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode==KeyEvent.KEYCODE_DPAD_DOWN || keyCode == KeyEvent.KEYCODE_8 || keyCode == KeyEvent.KEYCODE_DPAD_RIGHT)
            dir = 1;
        else if (keyCode==KeyEvent.KEYCODE_DPAD_UP || keyCode == KeyEvent.KEYCODE_2 || keyCode == KeyEvent.KEYCODE_DPAD_LEFT )
            dir = -1;
